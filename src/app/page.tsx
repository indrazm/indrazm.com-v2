      ...
      <main className="max-w-3xl m-auto my-12 space-y-24">
        ...
        <section className="space-y-8">
          ...
          <p className="text-lg text-stone-300 ">
            Driven by a passion for building intelligent and user-centric solutions, I&apos;m a software and AI engineer dedicated to bringing innovative ideas
            to life. My experience spans design, product development, and software engineering, allowing me to approach challenges with a holistic perspective
            and create impactful products that enhance human experiences.
          </p>
          <p className="text-lg text-stone-300 ">
